        ...
        <div class="aboutDetails" v-for="(item, index) in filteredAboutDetails" :key="index">
            <div class="about_section_2">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="image_2"><img :src="`http://localhost:5001/upload/images/${item.image[0]}`" :alt="item.image[0]"></div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="border_main">
                            <div class="image_4"><img :src="`http://localhost:5001/upload/images/${item.image[1]}`"></div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="border_main">
                            <div class="image_4"><img :src="`http://localhost:5001/upload/images/${item.image[2]}`"></div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="border_main">
                            <div class="image_4"><img :src="`http://localhost:5001/upload/images/${item.image[3]}`"></div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="border_main">
                            <div class="image_4"><img :src="`http://localhost:5001/upload/images/${item.image[4]}`"></div>
                        </div>
                    </div>
                </div>
            </div>
